...
**마지막 업데이트**: 2026-05-19 (TASK-026 큐잉 — 후속 질문 grounding 강화 + 설계 검토 회의록. 이전: 2026-05-14 TASK-025 큐잉)
**총 페이지 수**: 40 (루트 9 + wiki/ 18 + issues/open/ 7 + issues/resolved/ 6)
...
| 페이지 | 설명 | 날짜 |
|--------|------|------|
| [2026-05-19 후속질문 grounding 설계검토](wiki/meetings/2026-05-19-후속질문-grounding-설계검토.md) | 후속 질문이 LLM 통념으로 생성되는 품질 이슈 → 청크 grounding 보완안 확정, TASK-026 등록 | 2026-05-19 |
